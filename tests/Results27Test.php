...
class Results27Test extends TestCase
{
    ...
    {
        // 1. Wrapper function get_results_2026
        $res = get_results_2026('RTT', 'ar', false);
        $this->assertArrayHasKey('ix', $res);

        // 2. ResultsLoader class & results_loader_2026 function
        ...
        $htmlFromFunc = results_loader_2026($inputData);
