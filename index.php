...
print '<div style="float:right"><img src="//upload.wikimedia.org/wikipedia/commons/thumb/5/58/Wiki_Project_Med_Foundation_logo.svg/400px-Wiki_Project_Med_Foundation_logo.svg.png" decoding="async" width="200" height="200" ></div>';

print "<p>This tool looks for Wikidata items that have a page on mdwiki.org but not in another wikipedia language <a href='?cat=RTT&depth=1&code=ceb&doit=Do+it'><b>(Example)</b></a>.</p>" ;

print "<p><a href='//mdwiki.org/wiki/WikiProjectMed:Translation_task_force'><b>How to use.</b></a></p>
" ;
//-----------------------------
//===============================================
require ('form.php');
...
$test = $_GET['test'];
//--------------------------
function get_cat_members_with_py( $cat , $depth , $code ) {
    global $test;
    //---------------------------
...
$doit2 = false ;
//--------------------------
$coco = $code_to_lang[strtolower($_GET['code'])];
//--------------------------
if ( $coco != '' ) { $doit2 = true ; };
//--------------------------
if ( $doit  and $doit2 ) {
...
' ;
    ...
    //---------------------------
    $items = get_cat_members_with_py( $cat , $depth , $code ) ; # mdwiki pages in the cat
    //---------------------------
