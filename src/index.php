...
// ---
$form_start1  = print_form_start1($allow_whole_translate, MainTables::$x_Langs_table, TablesSql::$s_catinput_list, TablesSql::$s_campaign_input_list, $cat, $camp, $code_lang_name, $code, $tra_type, $global_username);
//---
$intro = <<<HTML
