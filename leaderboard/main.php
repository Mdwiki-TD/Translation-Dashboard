...
//---
// $m_years = fetch_query ("SELECT DISTINCT LEFT(pupdate, 4) AS year FROM pages WHERE pupdate <> ''");
$m_years2 = get_td_api(['get' => 'pages', 'select' => 'YEAR(pupdate) AS year', 'distinct' => "1", 'pupdate' => 'not_empty']);
//---
// compare_it($m_years, $m_years2);
//---
