...
$stylesheets = [
    ...
    "$hoste/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css",
...
$scripts = [
    ...
    "$hoste/ajax/libs/bootstrap/5.3.0/js/bootstrap.min.js",
    "$hoste/ajax/libs/twitter-bootstrap/5.3.0/js/bootstrap.bundle.min.js",
    "$hoste/ajax/libs/bootstrap-select/1.13.18/js/bootstrap-select.min.js",
